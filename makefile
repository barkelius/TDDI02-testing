...
g++ -o Game Game.cpp sdlFunctions.cpp printText.cpp StringInput.cpp functions.cpp character.cpp item.cpp room.cpp player.cpp Menu.cpp searchDirectory.cpp Editor.cpp EditorFunctions.cpp -lSDL -lSDL_image -lSDL_ttf
